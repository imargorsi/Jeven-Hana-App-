...
interface ICreatePostActionCardProps {
  onPress: () => void;
}

/**
 * Same pattern as CreateEventActionCard — gradient row CTA for Community.
 */
export function CreatePostActionCard({ onPress }: ICreatePostActionCardProps) {
  return (
    <Pressable
